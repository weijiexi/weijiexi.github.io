...
function setBackgroundColor(color) {
    ...
    // Get the element with the id "q1-container"
...
function yellowButtonClicked() {
    // Use the setBackgroundColor() to set the background color to "#FFD166 (or another color of your choice)
...
function greenButtonClicked() {
    // Use the setBackgroundColor() to set the background color to "#06D6A0 (or another color of your choice)
...
function lightblueButtonClicked() {
    // Use the setBackgroundColor() to set the background color to "#118AB2 (or another color of your choice)
...
function blueButtonClicked() {
    // Use the setBackgroundColor() to set the background color to "#073B4C (or another color of your choice)
